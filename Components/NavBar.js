  ...
  return (
    <div className="navbar bg-black text-white">
      <div className="flex-1">
        {/* <a className="btn btn-ghost text-3xl"><span className={caveat.className}>CartoOns</span></a> */}
